...
* **Windows Server 2016:** Primary Domain Controller / File Server.
* **Ubuntu Server 24.04:** Web & Database Application Server.
* **pfSense 2.7.2:** Network Firewall and Router (segmenting the environment).
